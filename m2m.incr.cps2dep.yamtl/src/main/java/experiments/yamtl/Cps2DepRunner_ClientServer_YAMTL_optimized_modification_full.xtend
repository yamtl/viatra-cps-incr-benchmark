...
class Cps2DepRunner_ClientServer_YAMTL_optimized_modification_full extends FullBenchmarkRunner {
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_ClientServer_YAMTL_optimized_modification_full
