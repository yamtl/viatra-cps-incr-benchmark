...
class Cps2DepRunner_SimpleScaling_YAMTL_modification_full extends FullBenchmarkRunner {
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_SimpleScaling_YAMTL_modification_full
