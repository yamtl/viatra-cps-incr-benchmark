...
class Cps2DepRunner_ViatraQrt_statistics_modification_full extends FullBenchmarkRunner {
	...
	override getIdentifier() {
		"cps2dep_statistics_viatraQrt_modification"
	}
...
//		#[1]
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_ViatraQrt_statistics_modification_full
