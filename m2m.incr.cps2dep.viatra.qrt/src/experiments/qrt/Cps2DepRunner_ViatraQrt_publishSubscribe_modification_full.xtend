...
class Cps2DepRunner_ViatraQrt_publishSubscribe_modification_full extends FullBenchmarkRunner {
...
//		#[1]
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_ViatraQrt_publishSubscribe_modification_full
