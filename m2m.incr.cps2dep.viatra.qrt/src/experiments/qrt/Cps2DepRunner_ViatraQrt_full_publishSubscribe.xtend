...
class Cps2DepRunner_ViatraQrt_full_publishSubscribe extends FullBenchmarkRunner {
	CPS2DeploymentTransformationQrt xform 
	AdvancedViatraQueryEngine engine
    var CPSToDeployment cps2dep
    
	override getIdentifier() {
		"cps2dep_publishSubscribe_viatraQrt"
	}
...
//		#[1]
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_ViatraQrt_full_publishSubscribe
