...
class Cps2DepRunner_ViatraExpl_publishSubscribe extends BenchmarkRunner {
...
//		#[1, 1, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192]
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_ViatraExpl_publishSubscribe
		runner.runBenchmark
	} 
...
//		var String outputModelPath = '''../m2m.batch.data/cps2dep/clientServer/deployment/viatraExpl'''
		var String inputModelPath = '''../m2m.batch.data/cps2dep/publishSubscribe/cps'''
		var String outputModelPath = '''../m2m.batch.data/cps2dep/publishSubscribe/deployment/viatraExpl'''
