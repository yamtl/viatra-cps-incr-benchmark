...
class Cps2DepRunner_ViatraExpl_full_clientServer extends FullBenchmarkRunner {
	CPS2DeploymentTransformation xform 
	AdvancedViatraQueryEngine engine  
    var CPSToDeployment cps2dep
    
	override getIdentifier() {
		"cps2dep_clientServer_viatraExpl"
	}
...
//		#[1]
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_ViatraExpl_full_clientServer
