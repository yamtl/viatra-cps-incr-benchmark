...
class Cps2DepRunner_statisticBased_ViatraExpl_modification_full extends FullBenchmarkRunner {
...
//		#[1]
	...
	def static void main(String[] args) {
		val runner = new Cps2DepRunner_statisticBased_ViatraExpl_modification_full
